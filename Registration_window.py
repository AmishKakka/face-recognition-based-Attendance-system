...
def submit():
    ...
    cv2.imwrite('../PYTHON/SE_project/photos/{}.jpg'.format(id), feed)
...
img_photo = comaptible_image_format('SE_project\home_button.jpeg')
...
camera_photo = comaptible_image_format(r'SE_project\camera_icon.jpeg')
...
retake_photo = comaptible_image_format(r'SE_project\retake_icon.jpeg')
